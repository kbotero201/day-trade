...
rsi_api_resp = RestClient.get("https://www.alphavantage.co/query?function=RSI&symbol=IBM&interval=60min&time_period=14&series_type=open&apikey=VLBVHKO2VWRJNR1W")
rsi_api_data =JSON.parse(rsi_api_resp)

macd_api_resp = RestClient.get("https://www.alphavantage.co/query?function=MACD&symbol=IBM&interval=60min&series_type=open&apikey=VLBVHKO2VWRJNR1W")
